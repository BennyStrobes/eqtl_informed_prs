...
for p_active_threshold in p_active_thresholds:
	for method in methods:
		...
		for chrom_num in range(1,23):
			component_file = bivariate_cafeh_output_dir + 'cafeh_results_' + trait_name + '_' + method + '_' + str(p_active_threshold) + '_num_prs_components_chrom_' + str(chrom_num) + '.txt'
		...
		t = open(bivariate_cafeh_output_dir + 'cafeh_results_' + trait_name+ '_' + method + '_' + str(p_active_threshold) + '_num_prs_components.txt', 'w')
